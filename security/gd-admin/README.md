...
## Purpose
Enable GuardDuty detectors per region, manage org membership, and auto-enroll new accounts.

## Responsibilities
- Execute from `envs/gd-admin/` root with least-privilege assume-role.
